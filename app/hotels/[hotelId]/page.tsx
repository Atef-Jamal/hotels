...
const HotelDetailsPage = () => {
  return (
    <section className="bg-slate-200 rounded-[2rem] sm:pt-4 lg:mt-10">
      <div className={cn("transition-all hidden lg:block -mt-12 mb-7 pb-1")}>
        <div className="w-[90%] lg:w-[85%] max-w-[1200px] mx-auto">
          <SearchBox />
        </div>
      </div>
      <div className="lg:max-w-[75rem] mx-auto">
        <div className="sm:hidden h-44 relative">
          <Image
            src={testImage}
            alt=""
        ...
        <div
          id={"overview-section"}
          className="mx-3 py-3 space-y-2 rounded-es-lg rounded-ee-lg bg-white relative mb-2 "
        >
        ...
        <div className="mx-3 p-3 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 rounded-lg bg-white mb-2">
        ...
        <div
          id={"rooms-section"}
          className="mx-3 p-3 space-y-2 md:space-y-4 rounded-lg bg-white mb-2"
        >
            ...
            <div className="inline-block w-48 bg-[#c9c3c35d] rounded-md overflow-hidden">
              ...
              <div className="p-2 space-y-1">
                ...
                <p className="text-xs text-muted-foreground h-20 whitespace-normal truncate">
                  ...
                  from your search (distance) 25 km from your search (distance)
                  25 km from your search (distance)
                </p>
          ...
          <div className="bg-white">
            <div className="p-1 flex items-center justify-between sm:px-2 md:px-4">
              <div className="flex flex-col items-center justify-center gap-y-1 ">
                <span className="font-extrabold text-4xl text-blue-800">
                  3.7
                </span>
            ...
            <div className=" whitespace-nowrap space-x-2 overflow-auto scrollbar-none py-3 pl-3">
              <div className="w-64 inline-block border border-zinc-500 p-3 rounded-md">
                ...
                <p className="h-24 whitespace-normal truncate text-sm text-muted-foreground font-medium">
                  ...
                  Helps Me Hello Everyone I see That Helps Me Hello Everyone I
                  see That Helps Me Hello Everyone I see That Helps Me Hello
                  Everyone I see That Helps Me Hello Everyone I see That Helps
                  Me Hello Everyone I see That Helps Me
                </p>
              </div>
              <div className="w-64 inline-block border border-zinc-500 p-3 rounded-md">
                <div className="flex items-center gap-x-3 mb-2">
        ...
        <div
          ...
          className="mx-3 p-3 space-y-3 rounded-lg bg-white mb-2"
        >
        ...
        <div
          ...
          className="mx-3 p-3 space-y-2 sm:space-y-4 rounded-lg bg-white mb-2"
        >
